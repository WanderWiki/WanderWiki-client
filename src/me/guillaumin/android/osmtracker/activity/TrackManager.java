...
public class TrackManager extends ListActivity {
	...
	/**
	 *  Data will be used in the case of creating a new track
	 */
...
//		cursor.close();
	...
	//		final EditText authorInput = (EditText) promptView.findViewById(R.id.authorInput);
			alertDialogBuilder
			 .setCancelable(false)
			 .setPositiveButton("OK", new DialogInterface.OnClickListener() {
				...
				//	i.putExtra(Schema.COL_AUTHOR, currentTrackId);
					startActivity(i);
	...
	protected void onListItemClick(ListView lv, View iv, final int position, final long id) {
		...
		if (id == currentTrackId) {
			...
			// show track info
			i = new Intent(this, ab.android.wanderwiki.activity.DisplayTrackDetail.class);
