...
public class TrackContentProvider extends ContentProvider {
	 ...
	 * Uri for user
	 */
	public static final Uri CONTENT_URI_USER = Uri.parse("content://" + AUTHORITY + "/" + Schema.TBL_USER);
	...
	private static final String[] TRACK_TABLES_PROJECTION = {
		...
		Schema.COL_TAGS,
		Schema.COL_DATABASE_ID,
		Schema.COL_LENGTH,
		Schema.COL_START_LAT,
		Schema.COL_START_LON,
		Schema.COL_END_LAT,
		Schema.COL_END_LON,
		Schema.COL_VOTE_POS,
		Schema.COL_VOTE_NEG,
		Schema.COL_ARTICLES,
		Schema.COL_IS_DOWNLOAD,
		Schema.COL_IS_UPLOADED,
		Schema.COL_IS_FINISHED,
		Schema.COL_IS_VOTED,
	...
	static {
		...
		uriMatcher.addURI(AUTHORITY, Schema.TBL_USER+ "/user/*", Schema.URI_CODE_USER);
	...
	public static final class Schema {
		...
		public static final String COL_END_LON ="end_lon";
		public static final String COL_VOTE_POS ="vote_pos";
		public static final String COL_VOTE_NEG ="vote_neg";
		public static final String COL_ARTICLES ="articles";
		public static final String COL_DOWNLOADS_NUMBER ="downloads_number";
		...
		public static final String COL_IS_FINISHED = "is_finished";
		public static final String COL_IS_VOTED = "is_voted";
		...
		public static final int URI_CODE_USER = 11;
